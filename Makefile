...
# Dynamics
# 
# Apply the dynamic of the current layer to all layers
#                             -------------------
#        begin                : 2013-03-07
#        copyright            : (C) 2013 by Alexia Mondot @ C-S
...
# translation
SOURCES = dynamics.py ui_dynamics.py __init__.py dynamicsdialog.py
#TRANSLATIONS = i18n/dynamics_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = contrastHomogenizer

PY_FILES = dynamics.py dynamicsdialog.py __init__.py
